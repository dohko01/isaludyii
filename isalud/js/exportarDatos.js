function fnExportarDatos() {
    href = $(this).attr('href');
    alert('Sea paciente, este proceso puede tardar varios minutos, depende de la cantidad de datos a procesar.');
    ...
    $.fileDownload(href, {
        ...
        'failCallback': function(responseHtml, url){ alert('Error al intentar descargar el archivo. '+responseHtml); }
        });
