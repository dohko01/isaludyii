...
(function() {
  ...
  */
  ...
  renderers = {
    ...
    "Tabla con gráfico de barras": function(pvtData, opts) {
      return $(pivotTableRenderer(pvtData, opts)).barchart();
    },
    "Mapa térmico": function(pvtData, opts) {
      return $(pivotTableRenderer(pvtData, opts)).heatmap();
    },
    "Mapa térmico sobre filas": function(pvtData, opts) {
      return $(pivotTableRenderer(pvtData, opts)).heatmap("rowheatmap");
    },
    "Mapa térmico sobre columnas": function(pvtData, opts) {
