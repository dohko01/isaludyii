		...
		$.widget("mn.sDashboard", {
			...
			_bindEvents : function() {
				...
				this.element.on("click", ".sDashboardWidgetHeader div.sDashboard-icon.sDashboard-circle-plus-icon", function(e) {
					...
					if ($(e.currentTarget).attr("title") === "Maximizar") {
						$(".sDashboard-overlay").show();
						$(e.currentTarget).attr("title", "Minimizar");
						self._trigger("widgetMaximized", null, {
							"widgetDefinition" : widgetDefinition
						});
					} else {
						$(".sDashboard-overlay").hide();
						$(e.currentTarget).attr("title", "Maximizar");
			...
			_constructWidget : function(widgetDefinition) {
				...
				var maximizeButton = $('<div title="Maximizar" class="sDashboard-icon sDashboard-circle-plus-icon "></span>');

				var deleteButton = $('<div title="Cerrar" class="sDashboard-icon sDashboard-circle-remove-icon"></div>');
				...
				if (widgetDefinition.hasOwnProperty("enableRefresh") && widgetDefinition.enableRefresh) {
					var refreshButton = $('<div title="Actualizar" class="sDashboard-icon sDashboard-refresh-icon "></div>');
					//add refresh button
