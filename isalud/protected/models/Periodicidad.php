...
/**
 * This is the model class for table "tblc_periodicidad".
 *
 * The followings are the available columns in table 'tblc_periodicidad':
 * @property integer $id
 ...
 */
class Periodicidad extends CActiveRecord
{
	/**
	 ...
	 * @return Periodicidad the static model class
	 */
