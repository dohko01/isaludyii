...
class PeriodicidadController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Periodicidad'];
			if($model->save())
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('Periodicidad');
	...
	public function actionAdmin()
	{
		...
		$model=new Periodicidad('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Periodicidad']))
			$model->attributes=$_GET['Periodicidad'];
	...
	{
		$model=Periodicidad::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Periodicidad $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='periodicidad-form')
		{
