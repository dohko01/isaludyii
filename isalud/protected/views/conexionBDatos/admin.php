...
$('.search-form form').submit(function(){
	$('#conexion-bdatos-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'conexion-bdatos-grid',
	'dataProvider'=>$model->search(),
	'filter'=>$model,
	'columns'=>array(
		'nombre',
        array(
            'name' => 'id_motor_bdatos',
            'value'=>'$data->MotorBDatos->nombre',
            'filter'=>CHtml::listData(MotorBDatos::model()->findAll(), 'id', 'nombre')
        ),
		'direccion',
		'usuario',
        'base_datos',
